\chap [chap:muscles] Neuromuskulární systém
    ...
    \sec [sec:neurons] Motorické neurony
    ...
    \sec [sec:contraction] Kontrakce a relaxace svalového vlákna
    ...
    \sec [sec:muscle-model] Modelování svalové činnosti
