\chap Princip fungování EMG
    ...
    \sec Hardwarové zpracování signálu EMG
        \rfc{REVIEW: vymyslet možná lepší název}
        Přístroje pro měření \glref{EMG} měří změny potenciálu v~jednotlivých svalech. Specificita měření se může velmi lišit, od měření jednotlivých vláken, přes svaly, až po celé svalové skupiny. \rfc{DONE: Přeformulovat} To záleží primárně na použité elektrodě a na filtrovaných frekvencích. Samotný přístroj je v~podstatě voltmetr, který měří napětí velká řádově milivolty a následně je zesiluje na vhodné velikosti a potlačuje šum. Cesta signálu je poté z~elektrod přes diferenciální zesilovač a filtry do AD převodníku.
        ...
        \secc Elektrody
            ...
            Elektrody s~přímým kontaktem bývaly dříve často měděné \rfc{DONE: Vážně?} a připevněny za pomoci leukoplasti. Jejich velkou výhodou je citlivost u~slabých signálů \glref{sEMG}, tedy například měření klidových svalových činností, naopak se nehodí pro měření dynamických pohybů z~důvodu omezení pohybu a jejich odlepování.
    ...
    \sec Umístění elektrod
        ...
        \secc Měření flexoru a extenzoru předloktí
            Toto umístění slouží k~sledování nespecifického \rfc{TODO: Přeformulovat} pnutí v~předloktí. Využívá se toho k~analýze zranění horní končetiny, např. z~repetitivních činností.
            ...
            \midinsert
                ...
                \caption/f Schéma umístění elektrod pro měření flexoru a extenzoru předloktí. Obrázek převzat od Kateřiny Doubkové; Data převzata z \cite[criswell2011cram]
            \endinsert
        ...
        \secc Měření extenzorů zápěstí
            ...
            \midinsert
                ...
                \caption/f Schéma umístění elektrod pro měření extenzorů předloktí. Obrázek převzat od Kateřiny Doubkové; Data převzata z \cite[criswell2011cram]
            \endinsert
        ...
        \secc Měření flexoru zápěstí
            ...
            \midinsert
                ...
                \caption/f Schéma umístění elektrod pro měření flexorů předloktí. Obrázek převzat od Kateřiny Doubkové; Data převzata z \cite[criswell2011cram]
            \endinsert
