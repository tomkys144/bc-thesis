\chap [chap:emg] Měření a modelování signálu EMG
    ...
    \sec [sec:emg-model] Modelování signálu EMG
        ...
        \rfc{TODO: ale hlavne by v~teorii meli byt vsechny veci ktere pouzivate dale v~praxy, takze ta autokorelace by tu fakt mela mit vlastni kapitolu, a vysvetlit jak to funguje}
